...
if($_POST){
	...
	if(isset($_POST['new_order'])) {
		...
		mysqli_real_escape_string($retailer), 
		mysqli_real_escape_string($user['id']),  
		mysqli_real_escape_string($user['first_name']),  
		mysqli_real_escape_string($user['last_name']),  
		mysqli_real_escape_string($user['email']),  
		mysqli_real_escape_string($product), 
		mysqli_real_escape_string($name), 
		mysqli_real_escape_string($designs),
