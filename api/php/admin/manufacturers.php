...
if ($_GET){
	...
	if (isset($_POST['new'])) {
		...
		$sql = sprintf("insert into manufacturers (activated,created,name,contact_name,contact_phone,contact_email,billing_email,invoice_amount,last_paid,logo,website) value (1, now(), '%s', '%s', '%s', '%s', '%s', '%s', now(), '%s', '%s')",
